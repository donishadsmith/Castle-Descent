                               ...
                               menu = function(castle_data,player,game_sequence){
                                 ...
                                 while(!player_action =="e"){
                                   ...
                                   while(!(player_action %in% c("a","d","s","e"))){
                                     player_action <- tolower(noquote(readline("a(left), d(right), s(select), e(exit): "))) 
                                   }
...
merchant <- merchant_class(item_costs = list("\U1F52E" = 50,"\U1F371" = 10,"\U0001f50e" = 1000,"\U1F9EA" = 40),
