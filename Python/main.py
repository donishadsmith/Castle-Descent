...
pygame.display.set_caption("Castle Descent")
...
# Initialize Castle
castle = Castle()
castle.initialize_grid().spawn()

# Player
player = Player()
player.pos = random.sample(castle.empty(), 1)[0]

# Zombie
zombie = Zombie()
zombie.pos = max_distance(player.pos, castle.empty())


# TODO: Refactor imports, initializations, and main game loop
